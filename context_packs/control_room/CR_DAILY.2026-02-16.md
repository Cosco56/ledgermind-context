## CR_DAILY v1 — 2026-02-16 (UTC=2026-02-16T21:55:02.4826151Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True (pid=26616 session=1)
- DATAQ: mw=HOLIDAY dhs=FAIL allow=False reason=market_window=HOLIDAY
- PRICES: ok=True ageMin=0.01014331 miss=0
...
- D: freeGB=629.8 freePct=67.9 label=DATA
- E: freeGB=1583.5 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=2
- Fails24hCount=2
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-02-15T21:57:01.0000000Z
  - FAIL task=LM-EOD-ReportLatest-2356 rc=3 lastRunUtc=2026-02-15T21:56:01.0000000Z
