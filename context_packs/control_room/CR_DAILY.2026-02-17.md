## CR_DAILY v1 — 2026-02-17 (UTC=2026-02-17T21:55:02.4594800Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False (pid=30088 session=1)
- DATAQ: mw=CLOSED dhs=PASS allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=1440.02301565833 miss=0
...
- C: freeGB=154.3 freePct=16.6 label=
- D: freeGB=623.7 freePct=67.2 label=DATA
- E: freeGB=1583.5 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=2
- Fails24hCount=3
  - FAIL task=LM-TX-Micro-CanarySplit-Start-Safe rc=1 lastRunUtc=2026-02-17T16:00:02.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-02-16T21:57:01.0000000Z
  - FAIL task=LM-EOD-ReportLatest-2356 rc=3 lastRunUtc=2026-02-16T21:56:01.0000000Z
