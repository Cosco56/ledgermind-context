## CR_DAILY v1 — 2026-08-19 (UTC=2026-08-19T11:32:03.4681890Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=54076 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=4.09839149833333 miss=0
...
- C: freeGB=737.6 freePct=79.3 label=: DATA
- D: freeGB=891.5 freePct=96.1 label=DATA
- E: freeGB=819.5 freePct=44 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=2
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-08-19T11:28:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-18T20:57:01.0000000Z
