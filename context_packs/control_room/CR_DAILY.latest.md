## CR_DAILY v1 — 2026-06-24 (UTC=2026-06-24T11:32:02.8484724Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=90440 session=1)
- DATAQ: mw=CLOSED dhs=PASS allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=4.01581801166667 miss=0
...
- C: freeGB=731.7 freePct=78.6 label=: DATA
- D: freeGB=899.7 freePct=97 label=DATA
- E: freeGB=837.1 freePct=45 label=LM-Data

### Tasks
- RunningCount=3
- Fails24hCount=1
  - FAIL task=LM-TX-Micro-RiskStop-Eval-1m rc=267014 lastRunUtc=2026-06-24T11:32:01.0000000Z
