## CR_DAILY v1 — 2026-09-10 (UTC=2026-09-10T13:47:03.7278833Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=115684 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=19.1182772166667 miss=0
...
- C: freeGB=732.5 freePct=78.7 label=: DATA
- D: freeGB=888.1 freePct=95.8 label=DATA
- E: freeGB=885.5 freePct=47.6 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=2
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-09-10T13:47:01.0000000Z
