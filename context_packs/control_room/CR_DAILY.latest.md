## CR_DAILY v1 — 2026-06-29 (UTC=2026-06-29T19:02:02.3642869Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=12276 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=4.00173423166667 miss=0
...
- C: freeGB=736.6 freePct=79.2 label=: DATA
- D: freeGB=899 freePct=96.9 label=DATA
- E: freeGB=887.1 freePct=47.7 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=1
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-06-29T18:58:01.0000000Z
