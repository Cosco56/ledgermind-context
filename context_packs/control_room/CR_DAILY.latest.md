## CR_DAILY v1 — 2026-08-04 (UTC=2026-08-04T12:32:03.6665154Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=178412 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=4.11347508833333 miss=0
...
- C: freeGB=730 freePct=78.4 label=: DATA
- D: freeGB=893.7 freePct=96.4 label=DATA
- E: freeGB=886.4 freePct=47.6 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=2
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-08-04T12:28:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-03T20:57:01.0000000Z
