## CR_DAILY v1 — 2026-08-06 (UTC=2026-08-06T16:02:04.2176064Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=21460 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=4.10241364 miss=0
...
- C: freeGB=729.7 freePct=78.4 label=: DATA
...
- RunningCount=8
- Fails24hCount=3
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-08-06T16:02:01.0000000Z
  - FAIL task=LM-IBGW-WindowControl-5m rc=1 lastRunUtc=2026-08-06T16:00:01.0000000Z
