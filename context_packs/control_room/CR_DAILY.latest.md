## CR_DAILY v1 — 2026-08-05 (UTC=2026-08-05T12:02:02.7733498Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=186072 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=4.07724814 miss=0
...
- C: freeGB=728.8 freePct=78.3 label=: DATA
- D: freeGB=893.5 freePct=96.3 label=DATA
- E: freeGB=882.4 freePct=47.4 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=2
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-08-05T11:58:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-04T20:57:01.0000000Z
