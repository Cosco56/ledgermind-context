## CR_DAILY v1 — 2026-08-28 (UTC=2026-08-28T17:32:03.2948274Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=16936 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=4.10503200333333 miss=0
...
- D: freeGB=890 freePct=96 label=DATA
- E: freeGB=888.8 freePct=47.8 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=2
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-08-28T17:32:01.0000000Z
