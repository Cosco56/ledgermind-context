## CR_DAILY v1 — 2026-04-20 (UTC=2026-04-20T17:47:03.0577480Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=5596 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=18.8993977 miss=0
- TRUTH: allow_new_orders=False reduce_only=True reason=nowrite_lock
- RISK: ok=False status=fail reasons=insufficient_trade_days_30d:5<10,pnl_stale_days:24.824>7 trade_days_30d=5
...
- C: freeGB=111.7 freePct=12 label=: DATA
- D: freeGB=215.6 freePct=23.2 label=DATA
- E: freeGB=1583.7 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=6
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-04-20T17:44:01.0000000Z
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-04-20T17:43:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-04-20T17:42:58.0000000Z
  - FAIL task=LM-IBGW-ApiCheck-PreOpen-1535 rc=2 lastRunUtc=2026-04-20T12:35:00.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-04-19T20:57:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-OnStart rc=3 lastRunUtc=2026-04-19T19:25:15.0000000Z
