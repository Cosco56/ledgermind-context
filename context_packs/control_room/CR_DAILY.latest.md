## CR_DAILY v1 — 2026-09-01 (UTC=2026-09-01T19:32:03.7438521Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=41296 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=4.09114153333333 miss=0
...
- C: freeGB=728.2 freePct=78.3 label=: DATA
...
- RunningCount=6
- Fails24hCount=3
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-09-01T19:32:01.0000000Z
