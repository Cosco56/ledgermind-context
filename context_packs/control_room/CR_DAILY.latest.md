## CR_DAILY v1 — 2026-05-01 (UTC=2026-05-01T17:32:02.5732366Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=42928 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=True reason=ok
- PRICES: ok=True ageMin=3.93770961333333 miss=0
...
- D: freeGB=140.5 freePct=15.1 label=DATA
- E: freeGB=1583 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=3
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-01T17:29:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-01T17:27:57.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-04-30T20:57:01.0000000Z
