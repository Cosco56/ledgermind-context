## CR_DAILY v1 — 2026-06-12 (UTC=2026-06-12T15:47:02.2070083Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=187432 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=19.0029085533333 miss=0
...
- C: freeGB=59.1 freePct=6.4 label=: DATA
- D: freeGB=901.4 freePct=97.2 label=DATA
- E: freeGB=830.7 freePct=44.6 label=LM-Data
