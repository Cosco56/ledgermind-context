## CR_DAILY v1 — 2026-03-06 (UTC=2026-03-06T17:47:01.7825975Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True (pid=41392 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=18.7942268083333 miss=0
...
- C: freeGB=136.5 freePct=14.7 label=
- D: freeGB=497 freePct=53.6 label=DATA
- E: freeGB=1584 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=3
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2147946720 lastRunUtc=2026-03-06T17:47:01.0000000Z
  - FAIL task=LM-TX-Live-Executor-1m rc=1 lastRunUtc=2026-03-06T17:46:27.0000000Z
  - FAIL task=LM-VBS-ZombieSweep-5m rc=1 lastRunUtc=2026-03-06T17:46:01.0000000Z
