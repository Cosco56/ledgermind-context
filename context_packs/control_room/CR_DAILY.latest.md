## CR_DAILY v1 — 2026-05-13 (UTC=2026-05-13T19:17:02.9686883Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=86176 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=True reason=ok
- PRICES: ok=True ageMin=18.97813778 miss=0
...
- C: freeGB=94.3 freePct=10.1 label=: DATA
...
- RunningCount=5
- Fails24hCount=3
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-13T19:14:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-13T19:12:57.0000000Z
