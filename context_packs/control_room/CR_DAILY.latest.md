## CR_DAILY v1 — 2026-06-18 (UTC=2026-06-18T18:02:02.3535112Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=47484 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=3.99043919833333 miss=0
...
- D: freeGB=900.6 freePct=97.1 label=DATA
- E: freeGB=838.3 freePct=45 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=1
  - FAIL task=LM-TX-Live-ReadinessSuperGate-1m rc=1 lastRunUtc=2026-06-18T18:01:58.0000000Z
