## CR_DAILY v1 — 2026-05-05 (UTC=2026-05-05T13:32:03.6896724Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=39528 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=3.94823854166667 miss=0
...
- C: freeGB=95.2 freePct=10.2 label=: DATA
- D: freeGB=114 freePct=12.3 label=DATA
- E: freeGB=1583 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=4
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-05T13:29:01.0000000Z
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-05-05T13:28:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-05T13:27:58.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-05-04T20:57:01.0000000Z
