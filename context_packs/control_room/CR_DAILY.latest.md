## CR_DAILY v1 — 2026-06-03 (UTC=2026-06-03T13:32:01.8770258Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=135660 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=3.95432473166667 miss=0
...
- C: freeGB=82.8 freePct=8.9 label=: DATA
- D: freeGB=902.7 freePct=97.3 label=DATA
- E: freeGB=1558.4 freePct=83.7 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=1
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2147946720 lastRunUtc=2026-06-03T13:32:01.0000000Z
