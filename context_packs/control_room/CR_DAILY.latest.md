## CR_DAILY v1 — 2026-08-19 (UTC=2026-08-19T14:02:03.5824597Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=41180 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=4.09690014666667 miss=0
...
- C: freeGB=739.8 freePct=79.5 label=: DATA
...
- RunningCount=5
- Fails24hCount=2
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-08-19T13:58:01.0000000Z
