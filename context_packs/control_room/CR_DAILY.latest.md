## CR_DAILY v1 — 2026-06-01 (UTC=2026-06-01T13:02:03.7500083Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=123508 session=1)
- DATAQ: mw=CLOSED dhs=PASS allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=4.02092156333333 miss=0
...
- C: freeGB=82.6 freePct=8.9 label=: DATA
- D: freeGB=903 freePct=97.4 label=DATA
- E: freeGB=1558.4 freePct=83.7 label=LM-Data

### Tasks
- RunningCount=3
- Fails24hCount=1
  - FAIL task=LM-DataQ-RealtimeGateWriter-1m rc=1 lastRunUtc=2026-06-01T13:02:01.0000000Z
