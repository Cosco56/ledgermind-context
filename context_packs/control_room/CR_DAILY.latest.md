## CR_DAILY v1 — 2026-02-23 (UTC=2026-02-23T23:47:02.5015161Z)
...
- PRICES: ok=True ageMin=18.7905387016667 miss=0
...
- C: freeGB=148.6 freePct=16 label=
- D: freeGB=582.9 freePct=62.8 label=DATA
- E: freeGB=1584 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=1
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-02-23T23:43:01.0000000Z
