## CR_DAILY v1 — 2026-05-26 (UTC=2026-05-26T13:02:02.8485644Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=80700 session=1)
- DATAQ: mw=CLOSED dhs=PASS allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=3.95213141 miss=0
...
- C: freeGB=93.2 freePct=10 label=: DATA
- D: freeGB=903.9 freePct=97.5 label=DATA
- E: freeGB=1559.5 freePct=83.8 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=4
  - FAIL task=LM-TruthGate-CompatEmit-1m rc=1 lastRunUtc=2026-05-26T13:02:01.0000000Z
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-26T12:59:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-26T12:57:57.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-05-25T20:57:02.0000000Z
