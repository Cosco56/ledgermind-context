## CR_DAILY v1 — 2026-08-17 (UTC=2026-08-17T12:17:02.8065001Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=17116 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=19.054730725 miss=0
...
- C: freeGB=735.7 freePct=79.1 label=: DATA
- D: freeGB=891.8 freePct=96.1 label=DATA
- E: freeGB=820.3 freePct=44.1 label=LM-Data

### Tasks
- RunningCount=3
- Fails24hCount=2
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-08-17T12:13:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-16T20:57:01.0000000Z
