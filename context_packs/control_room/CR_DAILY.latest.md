## CR_DAILY v1 — 2026-08-14 (UTC=2026-08-14T14:47:04.1848244Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=231320 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=19.0820352616667 miss=0
...
- C: freeGB=710 freePct=76.3 label=: DATA
- D: freeGB=892.2 freePct=96.2 label=DATA
- E: freeGB=838.3 freePct=45 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=2
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-08-14T14:47:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-13T20:57:01.0000000Z
