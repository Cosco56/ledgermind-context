## CR_DAILY v1 — 2026-04-14 (UTC=2026-04-14T14:02:04.4025572Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=45828 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=3.97992308166667 miss=0
- TRUTH: allow_new_orders=False reduce_only=True reason=nowrite_lock
- RISK: ok=False status=fail reasons=pnl_stale_days:18.668>7 trade_days_30d=10
...
- C: freeGB=109.7 freePct=11.8 label=: DATA
- D: freeGB=259.5 freePct=28 label=DATA
- E: freeGB=1583.2 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=7
  - FAIL task=LM-Truth-Recon-ExportsLatest-1m rc=13 lastRunUtc=2026-04-14T14:02:01.0000000Z
  - FAIL task=LM-TX-Recon-ExportsWriter-1m rc=2147946720 lastRunUtc=2026-04-14T14:02:01.0000000Z
  - FAIL task=LM-DataQ-Market-RefreshWrap-1m rc=1 lastRunUtc=2026-04-14T14:01:21.0000000Z
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-04-14T13:59:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-04-14T13:57:57.0000000Z
  - FAIL task=LM-IBGW-ApiCheck-PreOpen-1535 rc=2 lastRunUtc=2026-04-14T12:35:00.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-04-13T20:57:01.0000000Z
