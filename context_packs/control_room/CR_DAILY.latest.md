## CR_DAILY v1 — 2026-09-24 (UTC=2026-09-24T17:02:03.0165515Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=12472 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=2.623793805 miss=0
...
- C: freeGB=724.9 freePct=77.9 label=: DATA
...
- RunningCount=5
- Fails24hCount=3
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-09-24T17:02:01.0000000Z
