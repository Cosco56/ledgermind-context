## CR_DAILY v1 — 2026-08-12 (UTC=2026-08-12T12:32:02.6616158Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=189064 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=4.03610501833333 miss=0
...
- C: freeGB=714.5 freePct=76.8 label=: DATA
- D: freeGB=892.5 freePct=96.2 label=DATA
- E: freeGB=838.3 freePct=45 label=LM-Data
