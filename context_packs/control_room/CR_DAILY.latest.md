## CR_DAILY v1 — 2026-08-27 (UTC=2026-08-27T13:17:02.4219370Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=13584 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=19.0984237633333 miss=0
...
- C: freeGB=736.1 freePct=79.1 label=: DATA
- D: freeGB=890.2 freePct=96 label=DATA
- E: freeGB=888.8 freePct=47.8 label=LM-Data

### Tasks
- RunningCount=2
- Fails24hCount=3
  - FAIL task=LM-TruthGate-Hardening-Sentinel-5m rc=2 lastRunUtc=2026-08-27T13:13:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-OnStart rc=3 lastRunUtc=2026-08-27T10:04:45.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-26T20:57:01.0000000Z
