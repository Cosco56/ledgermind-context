## CR_DAILY v1 — 2026-07-10 (UTC=2026-07-10T17:17:02.5207275Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=30732 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=19.0127843066667 miss=0
...
- C: freeGB=738.7 freePct=79.4 label=: DATA
- D: freeGB=897.3 freePct=96.7 label=DATA
- E: freeGB=889.3 freePct=47.8 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=1
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-07-10T17:13:01.0000000Z
