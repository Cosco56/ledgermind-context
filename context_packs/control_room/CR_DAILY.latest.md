## CR_DAILY v1 — 2026-08-13 (UTC=2026-08-13T14:17:03.8163917Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=191948 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=19.1002607733333 miss=0
...
- C: freeGB=713.2 freePct=76.6 label=: DATA
- D: freeGB=892.4 freePct=96.2 label=DATA
- E: freeGB=838.3 freePct=45 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=2
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-08-13T14:17:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-12T20:57:01.0000000Z
