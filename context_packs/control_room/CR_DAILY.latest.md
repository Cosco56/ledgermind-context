## CR_DAILY v1 — 2026-06-26 (UTC=2026-06-26T17:32:02.6897822Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=96840 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=3.99683196666667 miss=0
...
- D: freeGB=899.4 freePct=97 label=DATA
- E: freeGB=837.1 freePct=45 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=1
  - FAIL task=LM-DataQ-RealtimeGateWriter-1m rc=1 lastRunUtc=2026-06-26T17:32:01.0000000Z
