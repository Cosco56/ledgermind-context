## CR_DAILY v1 — 2026-08-11 (UTC=2026-08-11T20:17:02.9060688Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=213880 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=196039.019185572 miss=0
...
- C: freeGB=716.1 freePct=77 label=: DATA
- D: freeGB=892.6 freePct=96.2 label=DATA
- E: freeGB=858.3 freePct=46.1 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=3
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2 lastRunUtc=2026-08-11T20:17:01.0000000Z
  - FAIL task=LM-TX-Micro-CanarySplit-Start-Safe rc=1 lastRunUtc=2026-08-11T15:00:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-10T20:57:01.0000000Z
