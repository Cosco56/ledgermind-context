## CR_DAILY v1 — 2026-02-22 (UTC=2026-02-22T03:17:02.3067499Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True (pid=19336 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=18.7848852833333 miss=0
...
- C: freeGB=151.8 freePct=16.3 label=
- D: freeGB=596.4 freePct=64.3 label=DATA
- E: freeGB=1583.5 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=3
- Fails24hCount=3
  - FAIL task=LM-TX-Micro-RiskStop-Eval-1m rc=1 lastRunUtc=2026-02-22T03:17:01.0000000Z
  - FAIL task=LM-ChatContextBundle-15m rc=1 lastRunUtc=2026-02-22T03:05:01.0000000Z
