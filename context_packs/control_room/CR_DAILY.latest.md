## CR_DAILY v1 — 2026-08-26 (UTC=2026-08-26T16:17:02.0339288Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=63852 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=19.09105321 miss=0
...
- C: freeGB=739.1 freePct=79.4 label=: DATA
- D: freeGB=890.3 freePct=96 label=DATA
- E: freeGB=821.8 freePct=44.2 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=2
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-08-26T16:13:01.0000000Z
