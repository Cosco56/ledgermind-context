## CR_DAILY v1 — 2026-03-31 (UTC=2026-03-31T19:02:02.8617810Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=34796 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=3.89726356666667 miss=0
...
- C: freeGB=120.1 freePct=12.9 label=: DATA
- D: freeGB=340.6 freePct=36.7 label=DATA
- E: freeGB=1583.9 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=4
  - FAIL task=LM-TX-Recon-ExportsWriter-1m rc=2147946720 lastRunUtc=2026-03-31T19:02:01.0000000Z
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2147946720 lastRunUtc=2026-03-31T19:02:01.0000000Z
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-03-31T18:59:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-03-30T20:57:01.0000000Z
