## CR_DAILY v1 — 2026-05-25 (UTC=2026-05-25T19:17:02.2704429Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=84960 session=1)
- DATAQ: mw=HOLIDAY dhs=FAIL allow=False reason=market_window=HOLIDAY
- PRICES: ok=True ageMin=18.9563578816667 miss=0
...
- D: freeGB=904 freePct=97.5 label=DATA
- E: freeGB=1559.5 freePct=83.8 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=3
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-25T19:14:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-25T19:12:57.0000000Z
