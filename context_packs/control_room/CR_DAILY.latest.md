## CR_DAILY v1 — 2026-04-10 (UTC=2026-04-10T14:02:01.7303617Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=41936 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=3.93068033666667 miss=0
- TRUTH: allow_new_orders=False reduce_only=True reason=nowrite_lock
- RISK: ok=False status=fail reasons=pnl_stale_days:14.668>7 trade_days_30d=13
...
- D: freeGB=282 freePct=30.4 label=DATA
- E: freeGB=1583.2 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=7
- Fails24hCount=7
  - FAIL task=LM-Truth-Recon-ExportsLatest-1m rc=13 lastRunUtc=2026-04-10T14:02:01.0000000Z
  - FAIL task=LM-TX-Recon-ExportsWriter-1m rc=2147946720 lastRunUtc=2026-04-10T14:02:01.0000000Z
  - FAIL task=LM-DataQ-Market-RefreshWrap-1m rc=1 lastRunUtc=2026-04-10T14:01:21.0000000Z
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-04-10T13:59:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-04-10T13:57:57.0000000Z
