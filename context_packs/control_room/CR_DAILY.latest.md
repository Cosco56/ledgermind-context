## CR_DAILY v1 — 2026-08-20 (UTC=2026-08-20T13:47:04.0628089Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=54836 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=19.1281592566667 miss=0
...
- C: freeGB=736.2 freePct=79.1 label=: DATA
- D: freeGB=891.3 freePct=96.1 label=DATA
- E: freeGB=819.5 freePct=44 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=2
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-08-20T13:47:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-19T20:57:02.0000000Z
