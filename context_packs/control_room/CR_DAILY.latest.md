## CR_DAILY v1 — 2026-02-15 (UTC=2026-02-15T13:17:01.4671946Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True (pid=42572 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=18.7994229883333 miss=0
...
- D: freeGB=770.1 freePct=83 label=DATA
- E: freeGB=1583.5 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=3
  - FAIL task=LM-IBGW-PortWatchdog-1m rc=1 lastRunUtc=2026-02-15T13:17:01.0000000Z
  - FAIL task=LM-TX-Micro-LiveReadyGate-5m rc=1 lastRunUtc=2026-02-15T13:14:01.0000000Z
