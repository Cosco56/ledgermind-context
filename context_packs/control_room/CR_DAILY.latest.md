## CR_DAILY v1 — 2026-09-14 (UTC=2026-09-14T18:17:03.0844494Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=48796 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=19.094551185 miss=0
...
- C: freeGB=746.4 freePct=80.2 label=: DATA
- D: freeGB=887.5 freePct=95.7 label=DATA
- E: freeGB=885.6 freePct=47.6 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=2
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-09-14T18:13:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-09-13T20:57:01.0000000Z
