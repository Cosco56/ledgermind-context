## CR_DAILY v1 — 2026-05-25 (UTC=2026-05-25T17:17:02.2274342Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=85944 session=1)
- DATAQ: mw=HOLIDAY dhs=FAIL allow=False reason=market_window=HOLIDAY
- PRICES: ok=True ageMin=18.9462961833333 miss=0
...
- C: freeGB=90.5 freePct=9.7 label=: DATA
...
- RunningCount=4
- Fails24hCount=3
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-25T17:14:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-25T17:12:57.0000000Z
