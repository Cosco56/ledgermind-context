## CR_DAILY v1 — 2026-08-25 (UTC=2026-08-25T17:02:03.6903012Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=66228 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=4.10625520833333 miss=0
...
- C: freeGB=741.3 freePct=79.7 label=: DATA
- D: freeGB=890.5 freePct=96 label=DATA
- E: freeGB=821.8 freePct=44.2 label=LM-Data

### Tasks
- RunningCount=8
- Fails24hCount=2
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-08-25T17:02:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-24T20:57:01.0000000Z
