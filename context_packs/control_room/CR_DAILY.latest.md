## CR_DAILY v1 — 2026-03-10 (UTC=2026-03-10T16:32:02.0700514Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False (pid=48192 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=3.82923304833333 miss=0
...
- D: freeGB=471.9 freePct=50.9 label=DATA
- E: freeGB=1584 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=7
- Fails24hCount=4
  - FAIL task=LM-TX-Recon-Eval-1m rc=2147946720 lastRunUtc=2026-03-10T16:32:01.0000000Z
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2147946720 lastRunUtc=2026-03-10T16:32:01.0000000Z
  - FAIL task=LM-VBS-ZombieSweep-5m rc=1 lastRunUtc=2026-03-10T16:31:01.0000000Z
