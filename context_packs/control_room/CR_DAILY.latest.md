## CR_DAILY v1 — 2026-09-11 (UTC=2026-09-11T18:02:02.1363512Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=21740 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=4.091131155 miss=0
...
- C: freeGB=733 freePct=78.8 label=: DATA
- D: freeGB=887.9 freePct=95.7 label=DATA
- E: freeGB=885.6 freePct=47.6 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=3
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-09-11T17:58:02.0000000Z
  - FAIL task=LM-EOD-UploadKit-OnStart rc=3 lastRunUtc=2026-09-11T10:58:00.0000000Z
