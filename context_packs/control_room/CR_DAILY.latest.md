## CR_DAILY v1 — 2026-06-30 (UTC=2026-06-30T17:02:02.7542570Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=9808 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=True reason=ok
- PRICES: ok=True ageMin=3.99231282666667 miss=0
...
- C: freeGB=734.9 freePct=79 label=: DATA
- D: freeGB=898.8 freePct=96.9 label=DATA
- E: freeGB=887.1 freePct=47.7 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=2
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-06-30T16:58:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-06-29T20:57:01.0000000Z
