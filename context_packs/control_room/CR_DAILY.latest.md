## CR_DAILY v1 — 2026-04-30 (UTC=2026-04-30T15:02:02.8007128Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=39160 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=True reason=ok
- PRICES: ok=True ageMin=3.92312768333333 miss=0
...
- C: freeGB=106.4 freePct=11.4 label=: DATA
- D: freeGB=149.3 freePct=16.1 label=DATA
- E: freeGB=1583 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=3
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-04-30T14:59:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-04-30T14:57:57.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-04-29T20:57:01.0000000Z
