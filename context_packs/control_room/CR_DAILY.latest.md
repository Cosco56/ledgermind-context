## CR_DAILY v1 — 2026-05-20 (UTC=2026-05-20T15:17:02.3589699Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=46848 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=True reason=ok
- PRICES: ok=True ageMin=18.9572039133333 miss=0
...
- C: freeGB=97.6 freePct=10.5 label=: DATA
- D: freeGB=904.7 freePct=97.5 label=DATA
- E: freeGB=1559.6 freePct=83.8 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=3
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-20T15:14:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-20T15:12:57.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-05-19T20:57:01.0000000Z
