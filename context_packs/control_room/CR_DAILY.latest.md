## CR_DAILY v1 — 2026-02-25 (UTC=2026-02-25T20:32:03.6660777Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True (pid=29716 session=3)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=3.79361750333333 miss=0
...
- C: freeGB=148 freePct=15.9 label=
- D: freeGB=571 freePct=61.6 label=DATA
- E: freeGB=1584 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=2
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2147946720 lastRunUtc=2026-02-25T20:32:01.0000000Z
  - FAIL task=LM-VBS-ZombieSweep-5m rc=1 lastRunUtc=2026-02-25T20:31:01.0000000Z
