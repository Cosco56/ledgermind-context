## CR_DAILY v1 — 2026-05-14 (UTC=2026-05-14T16:32:02.7614319Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=94260 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=True reason=ok
- PRICES: ok=True ageMin=3.96733125166667 miss=0
...
- D: freeGB=905.5 freePct=97.6 label=DATA
- E: freeGB=1560.1 freePct=83.8 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=3
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-14T16:29:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-14T16:27:57.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-05-13T20:57:01.0000000Z
