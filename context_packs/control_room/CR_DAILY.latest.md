## CR_DAILY v1 — 2026-09-15 (UTC=2026-09-15T19:02:03.0408096Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=63560 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=4.11869622166667 miss=0
...
- C: freeGB=732.7 freePct=78.7 label=: DATA
- D: freeGB=887.4 freePct=95.7 label=DATA
- E: freeGB=885.6 freePct=47.6 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=2
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-09-15T18:58:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-09-14T20:57:01.0000000Z
