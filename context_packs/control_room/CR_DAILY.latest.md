## CR_DAILY v1 — 2026-07-06 (UTC=2026-07-06T11:32:02.1655959Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=79968 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=4.00211561833333 miss=0
...
- D: freeGB=898 freePct=96.8 label=DATA
- E: freeGB=890.2 freePct=47.8 label=LM-Data

### Tasks
- RunningCount=3
- Fails24hCount=1
  - FAIL task=LM-DataQ-ContractGate-5m rc=2 lastRunUtc=2026-07-06T11:30:01.0000000Z
