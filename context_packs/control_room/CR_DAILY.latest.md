## CR_DAILY v1 — 2026-05-21 (UTC=2026-05-21T14:47:01.6905240Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=63096 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=18.9462006366667 miss=0
...
- C: freeGB=97.5 freePct=10.5 label=: DATA
- D: freeGB=904.6 freePct=97.5 label=DATA
- E: freeGB=1559.6 freePct=83.8 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=4
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2147946720 lastRunUtc=2026-05-21T14:47:01.0000000Z
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-21T14:44:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-21T14:42:57.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-05-20T20:57:01.0000000Z
