## CR_DAILY v1 — 2026-06-25 (UTC=2026-06-25T18:47:02.7550128Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=92912 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=19.0043423516667 miss=0
...
- D: freeGB=899.5 freePct=97 label=DATA
- E: freeGB=837.1 freePct=45 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=1
  - FAIL task=LM-DataQ-RealtimeGateWriter-1m rc=1 lastRunUtc=2026-06-25T18:47:01.0000000Z
