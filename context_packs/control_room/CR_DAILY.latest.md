## CR_DAILY v1 — 2026-03-02 (UTC=2026-03-02T13:47:02.3931918Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False (pid=44992 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=18.8007746783333 miss=0
...
- C: freeGB=144.8 freePct=15.6 label=
- D: freeGB=539.6 freePct=58.2 label=DATA
- E: freeGB=1584 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=3
- Fails24hCount=3
  - FAIL task=LM-VBS-ZombieSweep-5m rc=1 lastRunUtc=2026-03-02T13:46:01.0000000Z
  - FAIL task=LM-IBGW-ApiCheck-PreOpen-1535 rc=2 lastRunUtc=2026-03-02T13:35:00.0000000Z
