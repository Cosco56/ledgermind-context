## CR_DAILY v1 — 2026-08-11 (UTC=2026-08-11T16:02:03.9461667Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=198740 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=4.13260466 miss=0
...
- C: freeGB=717 freePct=77.1 label=: DATA
- D: freeGB=892.6 freePct=96.2 label=DATA
- E: freeGB=859.2 freePct=46.2 label=LM-Data

### Tasks
- RunningCount=7
- Fails24hCount=3
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-08-11T16:02:01.0000000Z
