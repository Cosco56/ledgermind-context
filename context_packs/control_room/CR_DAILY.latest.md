## CR_DAILY v1 — 2026-06-05 (UTC=2026-06-05T14:17:02.9110676Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=153584 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=True reason=ok
- PRICES: ok=True ageMin=18.9803035833333 miss=0
...
- C: freeGB=84.2 freePct=9 label=: DATA
- D: freeGB=902.4 freePct=97.3 label=DATA
