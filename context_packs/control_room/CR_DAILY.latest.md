## CR_DAILY v1 — 2026-05-04 (UTC=2026-05-04T11:32:03.2520505Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=15264 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=3.92173526333333 miss=0
...
- C: freeGB=96.8 freePct=10.4 label=: DATA
...
- RunningCount=3
- Fails24hCount=4
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-04T11:29:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-04T11:27:57.0000000Z
