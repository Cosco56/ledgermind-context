## CR_DAILY v1 — 2026-06-10 (UTC=2026-06-10T13:47:02.6877963Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=172592 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=18.7282272516667 miss=0
...
- C: freeGB=76.8 freePct=8.3 label=: DATA
- D: freeGB=901.7 freePct=97.2 label=DATA
- E: freeGB=1557.8 freePct=83.7 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=1
  - FAIL task=LM-DataQ-PricesKPI-Daily rc=124 lastRunUtc=2026-06-10T07:05:01.0000000Z
