## CR_DAILY v1 — 2026-06-02 (UTC=2026-06-02T17:32:02.6007740Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=131508 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=3.97926147 miss=0
...
- C: freeGB=85.2 freePct=9.2 label=: DATA
- D: freeGB=902.8 freePct=97.3 label=DATA
- E: freeGB=1558.4 freePct=83.7 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=1
  - FAIL task=LM-TXMicro-RiskStop-TradeDaysPostfix-5m rc=1 lastRunUtc=2026-06-02T17:31:01.0000000Z
