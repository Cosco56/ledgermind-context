## CR_DAILY v1 — 2026-09-16 (UTC=2026-09-16T18:32:03.5855154Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=67980 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=4.07867831833333 miss=0
...
- C: freeGB=729.4 freePct=78.4 label=: DATA
- D: freeGB=887.2 freePct=95.7 label=DATA
- E: freeGB=884.8 freePct=47.5 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=2
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-09-16T18:32:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-09-15T20:57:01.0000000Z
