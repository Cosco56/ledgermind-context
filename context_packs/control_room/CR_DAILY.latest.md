## CR_DAILY v1 — 2026-03-27 (UTC=2026-03-27T19:02:02.6269608Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=49572 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=3.86922230333333 miss=0
...
- C: freeGB=131.8 freePct=14.2 label=: DATA
- D: freeGB=366.2 freePct=39.5 label=DATA
- E: freeGB=1587.9 freePct=85.3 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=3
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2147946720 lastRunUtc=2026-03-27T19:02:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-03-27T18:57:57.0000000Z
