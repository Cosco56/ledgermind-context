## CR_DAILY v1 — 2026-07-01 (UTC=2026-07-01T19:02:02.8676872Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=57804 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=4.01146254833333 miss=0
...
- C: freeGB=734.1 freePct=78.9 label=: DATA
- D: freeGB=898.7 freePct=96.9 label=DATA
- E: freeGB=887.1 freePct=47.7 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=2
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-07-01T18:58:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-06-30T20:57:01.0000000Z
