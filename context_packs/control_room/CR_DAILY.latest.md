## CR_DAILY v1 — 2026-05-27 (UTC=2026-05-27T15:02:02.6014280Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=89412 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=3.99387993 miss=0
...
- C: freeGB=87.6 freePct=9.4 label=: DATA
- D: freeGB=903.7 freePct=97.4 label=DATA
- E: freeGB=1559.5 freePct=83.8 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=4
  - FAIL task=LM-TruthGate-CompatEmit-1m rc=1 lastRunUtc=2026-05-27T15:02:01.0000000Z
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-27T14:59:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-27T14:57:57.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-05-26T20:57:01.0000000Z
