## CR_DAILY v1 — 2026-05-07 (UTC=2026-05-07T19:32:02.3542361Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=44128 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=3.96783107333333 miss=0
...
- C: freeGB=101.8 freePct=10.9 label=: DATA
- D: freeGB=98.1 freePct=10.6 label=DATA
- E: freeGB=1582.6 freePct=85 label=LM-Data

### Tasks
- RunningCount=7
- Fails24hCount=5
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2147946720 lastRunUtc=2026-05-07T19:32:01.0000000Z
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-07T19:29:01.0000000Z
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-05-07T19:28:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-07T19:27:57.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-05-06T20:57:01.0000000Z
