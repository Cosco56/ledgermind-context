## CR_DAILY v1 — 2026-07-24 (UTC=2026-07-24T17:02:03.3122934Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=93360 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=4.04701701166667 miss=0
...
- D: freeGB=895.3 freePct=96.5 label=DATA
- E: freeGB=886.5 freePct=47.6 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=1
  - FAIL task=LM-TruthGate-Hardening-Sentinel-5m rc=2 lastRunUtc=2026-07-24T16:58:01.0000000Z
