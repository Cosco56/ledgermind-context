## CR_DAILY v1 — 2026-04-09 (UTC=2026-04-09T20:02:02.7111094Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=19884 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=3.93294602833333 miss=0
- TRUTH: allow_new_orders=False reduce_only=True reason=nowrite_lock
- RISK: ok=False status=fail reasons=pnl_stale_days:13.918>7 trade_days_30d=14
...
- C: freeGB=117.8 freePct=12.7 label=: DATA
- D: freeGB=286.5 freePct=30.9 label=DATA
- E: freeGB=1583.2 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=6
  - FAIL task=LM-Truth-Recon-ExportsLatest-1m rc=13 lastRunUtc=2026-04-09T20:02:01.0000000Z
  - FAIL task=LM-TX-Recon-ExportsWriter-1m rc=2147946720 lastRunUtc=2026-04-09T20:02:01.0000000Z
  - FAIL task=LM-DataQ-Market-RefreshWrap-1m rc=1 lastRunUtc=2026-04-09T20:01:21.0000000Z
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-04-09T19:59:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-04-09T19:57:57.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-04-08T20:57:01.0000000Z
