## CR_DAILY v1 — 2026-04-01 (UTC=2026-04-01T15:47:02.4266260Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=52828 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=18.887192515 miss=0
...
- C: freeGB=124.3 freePct=13.4 label=: DATA
- D: freeGB=333.4 freePct=35.9 label=DATA
- E: freeGB=1583.8 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=6
  - FAIL task=LM-Truth-Recon-ExportsLatest-1m rc=12 lastRunUtc=2026-04-01T15:47:01.0000000Z
  - FAIL task=LM-TX-Recon-ExportsWriter-1m rc=2147946720 lastRunUtc=2026-04-01T15:47:01.0000000Z
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2147946720 lastRunUtc=2026-04-01T15:47:01.0000000Z
  - FAIL task=LM-TX-Live-ReadinessSuperGate-1m rc=1 lastRunUtc=2026-04-01T15:46:58.0000000Z
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-04-01T15:44:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-03-31T20:57:01.0000000Z
