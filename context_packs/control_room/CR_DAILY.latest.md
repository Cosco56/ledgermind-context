## CR_DAILY v1 — 2026-04-27 (UTC=2026-04-27T19:47:02.0929378Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=41204 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=18.9423119616667 miss=0
...
- C: freeGB=105.9 freePct=11.4 label=: DATA
- D: freeGB=166.4 freePct=17.9 label=DATA
- E: freeGB=1583 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=3
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-04-27T19:44:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-04-27T19:42:57.0000000Z
