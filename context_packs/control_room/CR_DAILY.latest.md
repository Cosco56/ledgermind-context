## CR_DAILY v1 — 2026-08-03 (UTC=2026-08-03T20:02:04.4612045Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=117056 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=4.09163406666667 miss=0
...
- C: freeGB=723.1 freePct=77.7 label=: DATA
- D: freeGB=893.8 freePct=96.4 label=DATA
- E: freeGB=886.4 freePct=47.6 label=LM-Data

### Tasks
- RunningCount=8
- Fails24hCount=3
  - FAIL task=LM-DataQ-RealtimeGateWriter-1m rc=1 lastRunUtc=2026-08-03T20:02:01.0000000Z
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-08-03T20:02:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-02T20:57:01.0000000Z
