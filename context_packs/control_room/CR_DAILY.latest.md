## CR_DAILY v1 — 2026-07-07 (UTC=2026-07-07T17:17:02.1371728Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=98116 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=19.0195431916667 miss=0
...
- D: freeGB=897.8 freePct=96.8 label=DATA
- E: freeGB=890.2 freePct=47.8 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=1
  - FAIL task=LM-DataQ-RealtimeGateWriter-1m rc=1 lastRunUtc=2026-07-07T17:17:01.0000000Z
