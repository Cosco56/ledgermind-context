## CR_DAILY v1 — 2026-05-25 (UTC=2026-05-25T20:02:02.5379840Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=75144 session=1)
- DATAQ: mw=HOLIDAY dhs=FAIL allow=False reason=market_window=HOLIDAY
- PRICES: ok=True ageMin=3.962664145 miss=0
...
- RunningCount=3
- Fails24hCount=3
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-25T19:59:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-25T19:57:57.0000000Z
