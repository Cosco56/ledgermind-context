## CR_DAILY v1 — 2026-06-11 (UTC=2026-06-11T12:17:01.9561179Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=182276 session=1)
- DATAQ: mw=CLOSED dhs=PASS allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=18.9987268516667 miss=0
...
- C: freeGB=76.3 freePct=8.2 label=: DATA
- D: freeGB=901.6 freePct=97.2 label=DATA
