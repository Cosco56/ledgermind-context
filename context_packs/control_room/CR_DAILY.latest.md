## CR_DAILY v1 — 2026-08-19 (UTC=2026-08-19T12:02:02.6045964Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=50092 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=4.106400405 miss=0
...
- C: freeGB=739.5 freePct=79.5 label=: DATA
...
- RunningCount=4
- Fails24hCount=2
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-08-19T11:58:01.0000000Z
