## CR_DAILY v1 — 2026-05-06 (UTC=2026-05-06T18:47:02.7631752Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=33204 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=18.9439885833333 miss=0
...
- C: freeGB=108.5 freePct=11.7 label=: DATA
- D: freeGB=105.2 freePct=11.3 label=DATA
- E: freeGB=1582.6 freePct=85 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=4
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-05-06T18:44:02.0000000Z
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-05-06T18:43:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-05-06T18:42:57.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-05-05T20:57:01.0000000Z
