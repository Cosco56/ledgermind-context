## CR_DAILY v1 — 2026-08-06 (UTC=2026-08-06T14:17:04.1913924Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=193416 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=19.0796593566667 miss=0
...
- D: freeGB=893.4 freePct=96.3 label=DATA
- E: freeGB=877.8 freePct=47.2 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=2
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-08-06T14:17:01.0000000Z
