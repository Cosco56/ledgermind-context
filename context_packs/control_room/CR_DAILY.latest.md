## CR_DAILY v1 — 2026-02-22 (UTC=2026-02-22T16:17:03.3328429Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True (pid=4724 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=18.7970865566667 miss=0
...
- C: freeGB=149.9 freePct=16.1 label=
- D: freeGB=592.2 freePct=63.8 label=DATA
