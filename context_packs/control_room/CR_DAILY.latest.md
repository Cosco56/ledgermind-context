## CR_DAILY v1 — 2026-04-22 (UTC=2026-04-22T14:47:02.7744889Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=15368 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=True reason=ok
- PRICES: ok=True ageMin=18.91265011 miss=0
- TRUTH: allow_new_orders=False reduce_only=True reason=nowrite_lock
- RISK: ok=False status=fail reasons=insufficient_trade_days_30d:5<10,pnl_stale_days:26.699>7 trade_days_30d=5
...
- C: freeGB=113 freePct=12.1 label=: DATA
- D: freeGB=203.3 freePct=21.9 label=DATA
- E: freeGB=1583.7 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=5
  - FAIL task=LM-TruthGate-CompatEmit-1m rc=1 lastRunUtc=2026-04-22T14:47:01.0000000Z
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-04-22T14:44:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-04-22T14:42:57.0000000Z
  - FAIL task=LM-IBGW-ApiCheck-PreOpen-1535 rc=2 lastRunUtc=2026-04-22T12:35:00.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-04-21T20:57:01.0000000Z
