## CR_DAILY v1 — 2026-07-30 (UTC=2026-07-30T20:17:01.8781369Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=130588 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=178759.070086357 miss=0
...
- C: freeGB=722.8 freePct=77.7 label=: DATA
- D: freeGB=894.4 freePct=96.4 label=DATA
- E: freeGB=886.5 freePct=47.6 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=1
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2 lastRunUtc=2026-07-30T20:17:01.0000000Z
