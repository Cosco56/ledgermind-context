## CR_DAILY v1 — 2026-06-09 (UTC=2026-06-09T18:17:02.8327461Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=149748 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=18.9905942216667 miss=0
...
- C: freeGB=78.4 freePct=8.4 label=: DATA
- D: freeGB=901.8 freePct=97.2 label=DATA
- E: freeGB=1557.8 freePct=83.7 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=1
  - FAIL task=LM-DataQ-PricesKPI-Daily rc=124 lastRunUtc=2026-06-09T07:05:01.0000000Z
