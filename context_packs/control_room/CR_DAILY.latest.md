## CR_DAILY v1 — 2026-09-18 (UTC=2026-09-18T17:17:03.1000417Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=66836 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=19.1352326333333 miss=0
...
- C: freeGB=722.9 freePct=77.7 label=: DATA
- D: freeGB=886.9 freePct=95.6 label=DATA
- E: freeGB=884.8 freePct=47.5 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=2
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-09-18T17:17:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-09-17T20:57:01.0000000Z
