## CR_DAILY v1 — 2026-09-03 (UTC=2026-09-03T16:47:03.5055693Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=66484 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=19.1048965416667 miss=0
...
- C: freeGB=727.2 freePct=78.1 label=: DATA
- D: freeGB=889.1 freePct=95.9 label=DATA
- E: freeGB=887.2 freePct=47.7 label=LM-Data

### Tasks
- RunningCount=4
- Fails24hCount=2
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-09-03T16:43:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-09-02T20:57:01.0000000Z
