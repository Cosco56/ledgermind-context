## CR_DAILY v1 — 2026-09-24 (UTC=2026-09-24T16:32:03.5152833Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=4536 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=2.60226025166667 miss=0
...
- C: freeGB=725.5 freePct=78 label=: DATA
- D: freeGB=886 freePct=95.5 label=DATA
- E: freeGB=883.9 freePct=47.5 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=3
  - FAIL task=LM-IBGW-WindowControl-5m rc=1 lastRunUtc=2026-09-24T16:30:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-OnStart rc=3 lastRunUtc=2026-09-24T11:18:14.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-09-23T20:57:01.0000000Z
