## CR_DAILY v1 — 2026-03-23 (UTC=2026-03-23T19:47:02.7693952Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=60716 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=18.8694718433333 miss=0
...
- C: freeGB=127.8 freePct=13.7 label=
- D: freeGB=390.2 freePct=42.1 label=DATA
- E: freeGB=1583.5 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=5
  - FAIL task=LM-DataQ-RealtimeGateWriter-1m rc=1 lastRunUtc=2026-03-23T19:47:01.0000000Z
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2147946720 lastRunUtc=2026-03-23T19:47:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-03-23T19:42:57.0000000Z
  - FAIL task=LM-IBGW-ApiCheck-PreOpen-1535 rc=2 lastRunUtc=2026-03-23T13:35:00.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-03-22T21:57:01.0000000Z
