## CR_DAILY v1 — 2026-08-27 (UTC=2026-08-27T14:32:02.6474945Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=35032 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=4.09082969333333 miss=0
...
- C: freeGB=735.6 freePct=79 label=: DATA
...
- RunningCount=5
- Fails24hCount=3
  - FAIL task=LM-TX-SafetyMetrics-1m rc=1 lastRunUtc=2026-08-27T14:32:01.0000000Z
