## CR_DAILY v1 — 2026-06-11 (UTC=2026-06-11T16:47:02.2620741Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=174108 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=18.9913442716667 miss=0
...
- C: freeGB=73 freePct=7.8 label=: DATA
- D: freeGB=901.5 freePct=97.2 label=DATA
- E: freeGB=1557.8 freePct=83.7 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=2
  - FAIL task=LM-DataQ-RealtimeGate-1m rc=1 lastRunUtc=2026-06-11T16:47:01.0000000Z
  - FAIL task=LM-DataQ-PricesKPI-Daily rc=124 lastRunUtc=2026-06-11T07:05:01.0000000Z
