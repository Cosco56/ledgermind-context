## CR_DAILY v1 — 2026-09-01 (UTC=2026-09-01T20:17:03.0393947Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=36680 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=226279.072095842 miss=0
...
- C: freeGB=728.2 freePct=78.2 label=: DATA
- D: freeGB=889.4 freePct=95.9 label=DATA
- E: freeGB=888.8 freePct=47.8 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=4
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2 lastRunUtc=2026-09-01T20:17:01.0000000Z
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-09-01T20:13:02.0000000Z
  - FAIL task=LM-Ops-DailyDigest-1d rc=1 lastRunUtc=2026-09-01T06:10:02.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-31T20:57:01.0000000Z
