## CR_DAILY v1 — 2026-09-02 (UTC=2026-09-02T14:47:03.1263787Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=53476 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=19.0900718283333 miss=0
...
- C: freeGB=731.4 freePct=78.6 label=: DATA
- D: freeGB=889.3 freePct=95.9 label=DATA
- E: freeGB=888 freePct=47.7 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=2
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-09-02T14:47:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-09-01T20:57:01.0000000Z
