## CR_DAILY v1 — 2026-09-25 (UTC=2026-09-25T14:02:03.9952662Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=50716 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=2.634606205 miss=0
...
- D: freeGB=885.9 freePct=95.5 label=DATA
- E: freeGB=883.2 freePct=47.5 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=3
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-09-25T14:02:01.0000000Z
  - FAIL task=LM-IBGW-WindowControl-5m rc=1 lastRunUtc=2026-09-25T14:00:01.0000000Z
