...
- C: freeGB=136.3 freePct=14.6 label=
- D: freeGB=496.2 freePct=53.5 label=DATA
- E: freeGB=1584 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=3
- Fails24hCount=2
  - FAIL task=LM-TX-Live-Executor-1m rc=1 lastRunUtc=2026-03-07T03:16:27.0000000Z
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-03-07T03:13:01.0000000Z
