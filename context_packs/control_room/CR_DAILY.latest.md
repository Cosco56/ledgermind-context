## CR_DAILY v1 — 2026-04-06 (UTC=2026-04-06T18:17:02.6396173Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=9928 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=True reason=ok
- PRICES: ok=True ageMin=18.9134207766667 miss=0
- TRUTH: allow_new_orders=False reduce_only=True reason=nowrite_lock
- RISK: ok=False status=fail reasons=pnl_stale_days:10.845>7 trade_days_30d=15
...
- C: freeGB=121.7 freePct=13.1 label=: DATA
- D: freeGB=304.7 freePct=32.8 label=DATA
- E: freeGB=1583.8 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=5
  - FAIL task=LM-Truth-Recon-ExportsLatest-1m rc=13 lastRunUtc=2026-04-06T18:17:01.0000000Z
  - FAIL task=LM-TX-Recon-ExportsWriter-1m rc=2147946720 lastRunUtc=2026-04-06T18:17:01.0000000Z
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-04-06T18:14:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-04-06T18:12:57.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-04-05T20:57:01.0000000Z
