## CR_DAILY v1 — 2026-04-21 (UTC=2026-04-21T20:17:02.1900141Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=13064 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=34758.8919231133 miss=0
- TRUTH: allow_new_orders=False reduce_only=True reason=nowrite_lock
- RISK: ok=False status=fail reasons=insufficient_trade_days_30d:5<10,pnl_stale_days:25.929>7 trade_days_30d=5
...
- D: freeGB=208.5 freePct=22.5 label=DATA
- E: freeGB=1583.7 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=6
  - FAIL task=LM-TruthGate-CompatEmit-1m rc=1 lastRunUtc=2026-04-21T20:17:01.0000000Z
  - FAIL task=LM_MD_Refresh_OPEN_1m rc=2147946720 lastRunUtc=2026-04-21T20:17:01.0000000Z
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-04-21T20:14:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-04-21T20:12:57.0000000Z
  - FAIL task=LM-IBGW-ApiCheck-PreOpen-1535 rc=2 lastRunUtc=2026-04-21T12:35:00.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-04-20T20:57:01.0000000Z
