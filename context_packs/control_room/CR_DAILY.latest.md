## CR_DAILY v1 — 2026-08-24 (UTC=2026-08-24T17:47:03.6449751Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=61028 session=1)
- DATAQ: mw=OPEN dhs=FAIL allow=False reason=data_health_status=FAIL
- PRICES: ok=True ageMin=19.0554271233333 miss=0
...
- C: freeGB=740.4 freePct=79.6 label=: DATA
- D: freeGB=890.7 freePct=96 label=DATA
- E: freeGB=821.8 freePct=44.2 label=LM-Data

### Tasks
- RunningCount=6
- Fails24hCount=2
  - FAIL task=LM-IB-QuotesSnapshot-1m rc=2 lastRunUtc=2026-08-24T17:47:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-23T20:57:01.0000000Z
