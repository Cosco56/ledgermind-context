## CR_DAILY v1 — 2026-04-24 (UTC=2026-04-24T14:17:02.2939011Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=True sensor=inline_probe ageSec=0 (pid=54160 session=1)
- DATAQ: mw=OPEN dhs=PASS allow=False reason=ok
- PRICES: ok=True ageMin=18.9409134383333 miss=0
- TRUTH: allow_new_orders=False reduce_only=True reason=nowrite_lock
- RISK: ok=False status=fail reasons=insufficient_trade_days_30d:3<10,pnl_stale_days:28.679>7 trade_days_30d=3
...
- C: freeGB=109.9 freePct=11.8 label=: DATA
- D: freeGB=189.2 freePct=20.4 label=DATA
- E: freeGB=1583.7 freePct=85.1 label=LM-Data

### Tasks
- RunningCount=5
- Fails24hCount=5
  - FAIL task=LM-TXMicro-OrdersToTradeDay-5m rc=1 lastRunUtc=2026-04-24T14:14:01.0000000Z
  - FAIL task=LM-TruthGate-Hardening-StateNorm-5m rc=1 lastRunUtc=2026-04-24T14:13:01.0000000Z
  - FAIL task=LM-Ops-ObservabilitySmoke-5m rc=1 lastRunUtc=2026-04-24T14:12:57.0000000Z
  - FAIL task=LM-IBGW-ApiCheck-PreOpen-1535 rc=2 lastRunUtc=2026-04-24T12:35:00.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-04-23T20:57:01.0000000Z
