## CR_DAILY v1 — 2026-08-18 (UTC=2026-08-18T12:02:03.8064915Z)

### Core Status
- NOWRITE_PRESENT=True
- IBGW_RUNNING=True 4002_LISTEN=False sensor=inline_probe ageSec=0 (pid=40136 session=1)
- DATAQ: mw=CLOSED dhs=FAIL allow=False reason=market_window=CLOSED
- PRICES: ok=True ageMin=4.08474112833333 miss=0
...
- C: freeGB=741.1 freePct=79.6 label=: DATA
- D: freeGB=891.6 freePct=96.1 label=DATA
- E: freeGB=820.3 freePct=44.1 label=LM-Data

### Tasks
- RunningCount=3
- Fails24hCount=2
  - FAIL task=LM-TX-Micro-RiskStop-Eval-1m rc=267014 lastRunUtc=2026-08-18T12:02:01.0000000Z
  - FAIL task=LM-EOD-UploadKit-2357 rc=3 lastRunUtc=2026-08-17T20:57:01.0000000Z
